using System;
    ...
    public static class ConsoleEx
    {
        ...
        {
            var lines = Console.WindowHeight;
        ...
        public static Task ShowMenuAsync(string introduction, List<ConsoleMenuItem> consoleMenuItems, bool isRootMenu = false)
        {
            ...
            while (_continue)
            {
                ...
                Console.WriteLine(isRootMenu ? "Exit Application (c)" : "Back (b)");
        ...
        public static void WriteLine(string line, ConsolePosition? consolePosition = null)
        {
            ...
            {
                Console.WriteLine(line.PadLeft(line.Length + PaddingLeft));
            }
        }

        public static void WriteWholeLine(char c)
        {
            var times = Console.WindowWidth;
            ...
            while (!userDidAnswer)
                switch (Console.ReadLine()?.ToLower())
                {
                    ...
                    case "no":
                        ...
                        break;
                    default:
                        Console.WriteLine("Accepted Values are '[Y]es, [N]o'.");
                        break;
                }
        ...
        {
            for (var h = 0; h < Console.WindowHeight; h++)
            {
                if (h == Console.WindowHeight / 2)
                {
